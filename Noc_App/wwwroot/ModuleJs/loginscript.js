            ...
            success: function (response) {
                if (response.success == '1') {
                    ...
                    $.each(response.roles, function (key, value) {
                        ...
                        tr += '<input type="hidden" name="RoleID" id="RoleID" value="' + value.id + '"/><input type="hidden" name="role" id="rolename" value="' + value.roleName + '"/><div class="text-center" > <button type="submit" style="width:100%;background-color:brown" class="btn btn-success btn-user btn-block">' + value.roleName +'</button></div></form></td> ';
