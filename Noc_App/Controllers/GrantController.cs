                            ...
                            )
                        {
                            ...
                            if (isValid)
                            {
                                ...
                                //{
                                    ...
                                    additionalcalculation = "Additional Area Calculation With Amount ₹" + 250.ToString() + "per/Acre : On Additional " + Convert.ToDouble(area2)<0 ? (Convert.ToDouble(area2) * -1).ToString(): area2 + " Acres, Amount is ₹" + (TotalPayment + (count * 250) - 1000).ToString();
                                        TotalPayment = TotalPayment + (count * 250);
