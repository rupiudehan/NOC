    ...
    public class ApprovalProcessController : Controller
    {
        ...
        public async Task<IActionResult> Reject(GrantApprovalDetailReject model)
       {
        ...
        private List<LoginResponseViewModel> FetchUser()
        {
            ...
            user_info3 = new user_info { Name = "Superintending Engineer", Designation = "xyz", DesignationID = 1, Role = "Superintending Engineer", RoleID = 60, DivisionID = 178, Division = "test", DistrictID = 27, District = "Amritsar", EmailId = "co", EmpID = "125", MobileNo = "231221234", SubDivision = "", SubDivisionID = 0 };
