...
namespace Noc_App.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private List<LoginResponseViewModel> FetchUser()
        {
            ...
            user_info10 = new user_info { Name = "Administrator", Designation = "xyz", DesignationID = 1, Role = "Administrator", RoleID = 1.ToString(), DivisionID = 63, Division = "test", DistrictID = 27, District = "Amritsar", EmailId = "admin", EmpID = "132", MobileNo = "231221234", SubDivision = "", SubDivisionID = 0 };
