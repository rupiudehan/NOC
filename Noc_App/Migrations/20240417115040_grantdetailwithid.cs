...
{
    /// <inheritdoc />
    public partial class grantdetailwithid : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            string procedure = @"Create PROCEDURE applicationsdetailsget(grant_Id in numeric,village_id in numeric,tehsil_id in numeric,subDivision_id in numeric,division_id in numeric)
                                LANGUAGE 'plpgsql'
                                AS $BODY$

                                BEGIN
	                                SELECT GD.*,V.""Name"" AS VillageName ,t.""Name"" AS TehsilName,s.""Name"" AS SubDivisionName,
		                            d.""Name"" AS DivisionName,pt.""Name"" AS ProjectTypeName,NP.""Name"" AS NocPermissionTypeName
		                            ,NT.""Name"" AS NocTypeName
        ...
        {
            string procedure = @"Drop PROCEDURE applicationsdetailsget;";
            migrationBuilder.Sql(procedure);
        }
    }
}
