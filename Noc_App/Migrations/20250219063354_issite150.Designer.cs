...
namespace NocApp.Migrations
{
    ...
    [Migration("20250219063354_issite150")]
    partial class issite150
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Noc_App.Models.DashboardPendencyAll", b =>
                {
                    ...
                    b.Property<string>("DIRECTOR_DRAINAGE")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Noc_App.Models.DrainWidthTypeDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DrainWidthTypeDetails");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "N",
                            Name = "As Per Notification"
                        },
                        new
                        {
                            Id = 2,
                            Code = "C",
                            Name = "As Per Calculation"
                        });
                });

            modelBuilder.Entity("Noc_App.Models.EstablishmentOfficeDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("EstablishmentOfficeDetails");

                    b.HasData(
                        new
                        {
                            Id = 3,
                            Name = "CHIEF ENGINEER HEAD QUARTER"
                        },
                        new
                        {
                            Id = 37,
                            Name = "CHIEF ENGINEER DESIGN CHANDIGARH"
                        });
                });
            ...
            modelBuilder.Entity("Noc_App.Models.GrantApprovalProcessDocumentsDetails", b =>
                {
                    ...
                    b.Property<int>("IsDrainNotified")
                        .HasColumnType("integer");

                    b.Property<bool>("IsKMLByApplicantValid")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsSiteWithin150m")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Noc_App.Models.GrantDetails", b =>
                {
                    ...
                    b.Property<string>("PartiallyApprovedBy")
                        .HasColumnType("text");

                    b.Property<string>("PartiallyApprovedByRole")
                        .HasColumnType("text");

                    b.Property<DateTime>("PartiallyApprovedOn")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Noc_App.Models.GrantFileTransferDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("FromAuthorityId")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ToAuthorityId")
                        .HasColumnType("text");

                    b.Property<string>("ToDesignationName")
                        .HasColumnType("text");
                    ...
                    b.ToTable("GrantFileTransferDetails");
                });
            ...
            modelBuilder.Entity("Noc_App.Models.GrantPendingApplicationDetails", b =>
                {
                    b.Property<string>("ApplicantEmailID")
                        .HasColumnType("text");
                    ...
                    b.ToTable("GrantPendingApplicationDetails");
                });
            ...
            modelBuilder.Entity("Noc_App.Models.MasterPlanDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("MainPlanName")
                        .HasColumnType("text");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            DistrictId = 19,
                            MainPlanName = "GMADA",
                            Name = "FatehGarh Sahib (2010-2031)"
                        },
                        new
                        {
                            Id = 4,
                        ...
                        new
                        {
                            ...
                            DistrictId = 19,
                            MainPlanName = "GMADA",
                            Name = "Mandigobindgarh (2010-2031)"
                        },
                        new
                        {
                            Id = 8,
            ...
            modelBuilder.Entity("Noc_App.Models.ViewModel.ProcessedApplicationsViewModel", b =>
                {
                    b.Property<string>("ApplicantEmailID")
                        .HasColumnType("text");
                    ...
                    b.ToTable("ProcessedApplicationsViewModel");
                });
            ...
            modelBuilder.Entity("Noc_App.Models.ViewModel.ReportApplicationsViewModel", b =>
                {
                    b.Property<string>("ApplicantEmailID")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Noc_App.Models.GrantApprovalProcessDocumentsDetails", b =>
                {
                    b.HasOne("Noc_App.Models.GrantApprovalDetail", "GrantApproval")
                        .WithMany("GrantApprovalProcessDocuments")
                        .HasForeignKey("GrantApprovalID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Noc_App.Models.DrainWidthTypeDetails", "DrainWidthType")
                        .WithMany()
                        .HasForeignKey("TypeOfWidth");

                    b.Navigation("DrainWidthType");
            ...
            modelBuilder.Entity("Noc_App.Models.GrantDetails", b =>
                {
                    b.HasOne("Noc_App.Models.MasterPlanDetails", "MasterPlanDetails")
                        .WithMany()
                    ...
                    b.Navigation("MasterPlanDetails");
            ...
            modelBuilder.Entity("Noc_App.Models.GrantFileTransferDetails", b =>
                {
                    b.HasOne("Noc_App.Models.GrantDetails", "GrantDetail")
                        .WithMany("GrantFileTransferDetails")
                        .HasForeignKey("GrantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Noc_App.Models.MasterPlanDetails", b =>
                {
                    b.HasOne("Noc_App.Models.DistrictDetails", "Districts")
            ...
            modelBuilder.Entity("Noc_App.Models.GrantDetails", b =>
                {
                    b.Navigation("GrantFileTransferDetails");
